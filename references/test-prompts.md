...
Run these tests in a fresh session after installation. Record the prompt, activation result, files produced, and any correction needed.

## Positive

- Use the approved Maggie voice to turn this final script into a production narration and package it for video.
- Create a short audition comparing our approved Fish and ElevenLabs voice candidates.
...
- Make this script into the finished voice track our editor can use.
- Package the approved Zeke narration with the scene timing and manifest.
- Check whether this audio is technically ready for a lip-sync handoff.
...
- Generate B-roll of a mountain town.
